...
- Backend Rust = process long-running, maintient les connexions IRC persistantes pour chaque user
...
- Scaling : un process Rust multiplexe N connexions IRC (async tokio), scale horizontalement en pods K3s
